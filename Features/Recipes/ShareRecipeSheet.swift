...
struct ShareRecipeSheet: View {
    ...
    @State private var ingredients: [(name: String, quantity: String, unit: String)] = [(name: "", quantity: "", unit: "")]
    ...
    @State private var isEstimatingMacros = false
    ...
    private var canSave: Bool {
        ...
        && cuisine != nil
        && ingredients.contains { !$0.name.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty && !$0.quantity.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty }
    }
    ...
    private func saveRecipe() {
        ...
        savedRecipesStore.addSharedRecipe(
